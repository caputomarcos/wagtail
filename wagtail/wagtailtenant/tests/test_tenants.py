...
from wagtail.wagtailtenant.test.cases import TenantTestCase
from wagtail.wagtailtenant.tests.models import Tenant, NonAutoSyncTenant
from wagtail.wagtailtenant.tests.testcases import BaseTestCase
from wagtail.wagtailtenant.utils import tenant_context, schema_context, schema_exists, get_tenant_model, get_public_schema_name
...
class TenantSyncTest(BaseTestCase):
    ...
    def test_shared_apps_does_not_sync_tenant_apps(self):
        ...
        the a tenant schema.
        """
        settings.SHARED_APPS = ('wagtailtenant',  # 2 tables
